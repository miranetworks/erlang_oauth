...
is_authorized(_) ->
    ...
    Result4 = oauth_utils:is_authorized('GET', "http://localhost:8000", "/foo", [{"bar","baz"}], "OAuth oauth_signature=\"ImJG%2B%2FSO9K9CuxSWBkrvDNL4Tio%3D\", oauth_version=\"1.0\", oauth_nonce=\"ABD0Pe6ga2jAfI0lyG8dVRoQUyJuzv9d%2Fm1FSgn8K3k%3D\", oauth_timestamp=\"1401710539\", oauth_signature_method=\"HMAC-SHA1\", oauth_consumer_key=\"key\"", fun consumer_lookup/1),
    Result5 = oauth_utils:is_authorized('POST', "http://localhost:8000", "/foo", [], "OAuth oauth_signature=\"VDLo1TGwr6orIvj0rKJbp4YB%2BtI%3D\", oauth_version=\"1.0\", oauth_nonce=\"dT1lilc1CeN4181AgTpySpaXdTPR484EOZyP%2BWmY4Ww%3D\", oauth_timestamp=\"1401710539\", oauth_signature_method=\"HMAC-SHA1\", oauth_consumer_key=\"key\"", fun consumer_lookup/1),
    [
